    ...
    for list in image_list[category]:
      ...
      with tf.Session(graph=graph) as sess:        
        for image in image_list[category][list]:            
          ...
          sys.stdout.write('\r>> Processing %d images. Total data true = %d. Accuracy %.2f%%' % (total_data, data_true, accuracy))
          sys.stdout.flush()
  


  tf.logging.info('Process done! Final accuracy %.2f%%' % (accuracy))